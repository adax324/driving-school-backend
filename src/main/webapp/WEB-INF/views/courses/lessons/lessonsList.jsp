...
<link rel="stylesheet"
      href='<c:url value="../../dynamic/plugins/datatables-responsive/css/responsive.bootstrap4.min.css"/>'>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class=" mb-2 col-sm-2 col-md-2">
                                        <a href='<c:url value="/lesson/selectcity"/>' class="btn btn-success">+ Dodaj
                                            lekcję</a>
                                    </div>
                                </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <c:forEach items="${quests}" var="variable">
                                        <tr>
                                            ...
                                            <td>
                                                <a style="text-decoration: none" href='<c:url value="/lesson/editquest/${variable.questId}"/>'><button class="btn-sm btn-secondary btn-block">
                                                    Edytuj
                                                </button></a>
                                            </td>
                                        </tr>
